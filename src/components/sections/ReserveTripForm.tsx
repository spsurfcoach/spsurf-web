...
export function ReserveTripForm() {
  ...
  return (
    <section id="reserva" className="section-space bg-zinc-900 px-4 sm:px-6 md:px-10 lg:px-16">
      <div className="grid gap-10 lg:grid-cols-2">
        <div className="space-y-4">
          <h2 className="ds-h2 text-white">Reserva tu surftrip</h2>
          <p className="ds-body-s text-zinc-300">
            Completa tus datos para separar tu cupo. Luego podrás ir al link de pago para confirmar la reserva.
          </p>
        ...
        <div className="rounded-2xl border border-white/15 bg-zinc-950 p-4 sm:p-6">
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <textarea
              ...
              rows={4}
              className="ds-input min-h-[112px] resize-none py-3"
            />
