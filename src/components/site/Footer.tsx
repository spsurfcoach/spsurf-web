        ...
        <div>
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="mt-5 flex items-center gap-4">
                <a
                  href="https://wa.me/51998153542"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="WhatsApp SP Surf Coach"
                  className="flex items-center gap-2 text-white/70 transition-colors hover:text-white"
                >
                  <WhatsAppIcon />
                  <span className="ds-chip">+51 998 153 542</span>
                </a>
              </div>
              <div className="mt-3 flex items-center gap-4">
                <a
                  href="https://www.instagram.com/spsurfcoach"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="Instagram SP Surf Coach"
                  className="flex items-center gap-2 text-white/70 transition-colors hover:text-white"
                >
                  <InstagramIcon />
                  <span className="ds-chip">@spsurfcoach</span>
                </a>
              </div>
            </div>
          ...
          <div className="mt-10 flex flex-col gap-4 border-t border-white/15 pt-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-wrap gap-x-5 gap-y-2">
              ...
              <Link href="/politicas" className="ds-chip text-white/70 hover:text-white">
                Políticas
              </Link>
            </div>
