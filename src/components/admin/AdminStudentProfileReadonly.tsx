...
const FIELD_LABELS: Partial<Record<keyof UserProfileDoc, string>> = {
  ...
  acceptsTerms: "Acepta términos y condiciones (SP Surf Coach)",
  consentsMarketingCommunications: "Autoriza comunicaciones comerciales / promociones",
...
const FIELD_ORDER: (keyof UserProfileDoc)[] = [
  ...
  "acceptsTerms",
  "consentsMarketingCommunications",
  "createdAt",
  "updatedAt",
];
