...
export const metadata: Metadata = {
  title: "Surftrips",
  description:
    "Surf camps internacionales con coaching, videoanálisis y entrenamiento integral. Únete a los próximos viajes de SP Surf Coach.",
};
...
const surftripsFaqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Recomendamos traer tu propia tabla y wetsuit para entrenar con el equipo que ya conoces. En caso no cuentes con estos, nos puedes avisar y organizaremos los equipos que usarás durante el trip.",
  },
  {
